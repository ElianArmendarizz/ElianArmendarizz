...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=36BCF7&center=true&vCenter=true&width=600&lines=Frontend+Developer;Mobile+Developer;React+Native+Engineer" alt="Typing SVG" />

<p align="center">
  <strong>💻 Frontend • 📱 Mobile • ⚛️ React Native</strong>
</p>
...
const elian = {
  ...
  especializacion: ["Frontend Web", "Desarrollo Móvil", "Interfaces Interactivas"],
  enfoqueActual: "React Native + TypeScript",
  aprendiendo: ["Fullstack Development", "Patrones Avanzados", "Arquitectura de Software"],
  pasion: "Crear experiencias digitales que conectan tecnología y cultura",
  disponible: true
};
```
...
- 💬 Pregúntame sobre **React Native, JavaScript, TypeScript, PHP + MySQL**
- ⚡ Dato curioso: **Transformo tradiciones mexicanas en código 🎲**
...
![](https://github-readme-activity-graph.vercel.app/graph?username=ElianArmendarizz&theme=tokyo-night&hide_border=true&area=true&custom_title=Gráfica%20de%20Contribuciones)
...
const objetivos2026 = {
  corto_plazo: [
    ...
    "Fortalecer habilidades en arquitectura de software"
  ],
  mediano_plazo: [
    "Evolucionar hacia Fullstack Developer",
    "Dominar patrones avanzados de React Native",
    "Liderar proyectos técnicos"
  ],
  largo_plazo: [
    "Arquitecto de Software",
    "Contribuir a la comunidad open-source",
    "Mentoría de nuevos desarrolladores"
  ]
};
```
...
[![spotify-github-profile](https://spotify-github-profile.vercel.app/api/view?uid=31abcxyz1234567890&cover_image=true&theme=novatorem&show_offline=false&background_color=121212&interchange=false&bar_color=53b14f&bar_color_cover=false)](https://spotify-github-profile.vercel.app/api/view?uid=31abcxyz1234567890&redirect=true)
...
🎯 **Buscando:** Posición como Desarrollador Frontend/Mobile Junior  
📍 **Ubicación:** Veracruz, México (Disponible para remoto)  
🚀 **Intereses:** Proyectos desafiantes, startups, desarrollo de producto  
...
> *"El mejor código es el que resuelve problemas reales y mejora vidas"*

**Ingeniero en Sistemas Computacionales** • **Frontend & Mobile Developer**  
**Universidad Jean Piaget** (2022-2025)
